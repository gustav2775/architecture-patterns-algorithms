...
$user_1 = new User('Иван Иванов', 15, 'ivan@mail.ru', new Email(new Messege($text)));
$user_2 = new User('Екатерина Иванова', 6, 'ekaterina@mail.ru', new Email(new Messege($text)));
